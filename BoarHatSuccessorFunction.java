    ...
    public List getSuccessors(Object aState) {
        ...
        for (int i = 0; i < board.getNClients(); i++) {
            for (int j = 0; j < board.getNCentrals(); j++) {
                ...
                String S = "Consum = " +consum+ " Produccio = " + produccio + " Produccio Left " + produccioLeft + " -- " + String.valueOf(produccio - consum);
                S = S + "Beneficis = "+ x + " " + y +" " + z + " "+BoarHat.INTERCAMBIO + " " + i + " " + j + " Coste(" + v + ") ---> " + newBoard.toString();
